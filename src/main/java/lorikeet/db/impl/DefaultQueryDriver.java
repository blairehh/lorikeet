...
public class DefaultQueryDriver {

    private static final Logger log = LoggerFactory.getLogger(DefaultQueryDriver.class);
    ...
    public DefaultQueryDriver(Seq<Object> connConfigurations, Dict<Class<? extends QueryPlan>, ? extends QueryPlanExecutor<?, ?, ?>> executors) {
