...
public class Module implements LorikeetType {
    ...
    public Module(File file, Type type, Set<Attribute> attributes) {
    ...
    public Module(File file, Type type, Set<Attribute> attributes, List<Function> funcs) {
        this.origin = new Origin.Source(file);
        this.type = type;
        this.attributes = attributes;
    ...
    public Module(Type type, Set<Attribute> attributes) {
        this.origin = null;
        this.type = type;
        this.attributes = attributes;
        this.functions = new ArrayList<Function>();
    ...
    public Module(Type type, Set<Attribute> attributes, List<Function> funcs) {
        this.origin = null;
        this.type = type;
        this.attributes = attributes;
        this.functions = funcs;
