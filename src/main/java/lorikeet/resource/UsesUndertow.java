...
public interface UsesUndertow<R extends UsesLogging & UsesCoding & UsesHttpServer, A extends ProvidesHttpReceptors<R> & ProvidesTract<R>> extends UsesHttpServer {
