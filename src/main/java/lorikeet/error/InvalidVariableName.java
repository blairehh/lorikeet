...
public class InvalidVariableName implements CompileError {
    private final String value;
    private final TokenSeq tokenSeq;
    private final Token token;

    public InvalidVariableName(String value, Token token, TokenSeq tokenSeq) {
        this.value = value;
        this.tokenSeq = tokenSeq;
        this.token = token;
    }

    public InvalidVariableName(TokenSeq tokenSeq) {
    ...
    public boolean equals(Object o) {
        ...
        InvalidVariableName that = (InvalidVariableName)o;
