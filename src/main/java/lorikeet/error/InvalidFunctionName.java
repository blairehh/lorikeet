...
public class InvalidFunctionName implements CompileError {
    private final String value;
    private final TokenSeq tokenSeq;
    private final Token token;

    public InvalidFunctionName(String value, Token token, TokenSeq tokenSeq) {
        this.value = value;
        this.tokenSeq = tokenSeq;
        this.token = token;
    }

    public InvalidFunctionName(TokenSeq tokenSeq) {
    ...
    public void outputTo(Console console) {
        ...
        console.print(
            "Function of '%s' is invalid. A name must adhere to [a-z][A-Za-z0-9]*",
            this.getValue()
        );
    }
    ...
    public boolean equals(Object o) {
        ...
        InvalidFunctionName that = (InvalidFunctionName)o;
