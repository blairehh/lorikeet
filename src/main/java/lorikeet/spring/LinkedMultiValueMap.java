...
/*
    SOURCE:
    https://github.com/spring-projects/spring-framework/blob/master/spring-core/src/main/java/org/springframework/util/LinkedMultiValueMap.java

    LORIKEET CHANGES
    repackaged org.springframework.util to lorikeet.spring
