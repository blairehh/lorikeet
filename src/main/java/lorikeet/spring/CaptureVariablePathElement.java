...
/*
    SOURCE:
    https://github.com/spring-projects/spring-framework/blob/master/spring-web/src/main/java/org/springframework/web/util/pattern/CaptureVariablePathElement.java

    LORIKEET CHANGES:
    repackaged org.springframework.web.util.pattern to lorikeet.spring
