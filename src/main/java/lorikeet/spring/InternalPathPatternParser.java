...
/*
    SOURCE:
    https://github.com/spring-projects/spring-framework/blob/master/spring-web/src/main/java/org/springframework/web/util/pattern/InternalPathPatternParser.java

    LORIKEET CHANGES:
    repackaged from org.springframework.web.util.pattern to lorikeet.spring
    replaced org.springframework.web.util.pattern.PathElement with lorikeet.spring.PathElement
    removed usage of @Nullable
    replaced org.springframework.util.Assert with lorikeet.spring.Assert
    replaced org.springframework.web.util.pattern.PatternParseException.PatternMessage with lorikeet.spring.PatternParseException.PatternMessage
    replaced org.springframework.web.util.pattern.WildcardTheRestPathElement with lorikeet.spring.WildcardTheRestPathElement
    replaced org.springframework.web.util.pattern.SeparatorPathElement with lorikeet.spring.SeparatorPathElement
    replaced org.springframework.web.util.pattern.CaptureTheRestPathElement with lorikeet.spring.CaptureTheRestPathElement
 */
...
import lorikeet.spring.PatternParseException.PatternMessage;
