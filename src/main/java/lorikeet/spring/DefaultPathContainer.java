...
/*
    SOURCE:
    https://github.com/spring-projects/spring-framework/blob/master/spring-web/src/main/java/org/springframework/http/server/DefaultPathContainer.java

    LORIKEET CHANGES
    repackaged org.springframework.http.server to lorikeet.spring
    replaced org.springframework.util.Assert with lorikeet.spring.Assert
    replaced org.springframework.util.CollectionUtils with lorikeet.spring.CollectionUtils
    replaced org.springframework.util.MultiValueMap with lorikeet.spring.MultiValueMap
    replaced org.springframework.util.StringUtils with lorikeet.spring.StringUtils
    replaced org.springframework.util.LinkedMultiValueMap with lorikeet.spring.LinkedMultiValueMap
