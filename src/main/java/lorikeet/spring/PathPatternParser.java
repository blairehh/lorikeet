...
/*
    SOURCE:
    https://github.com/spring-projects/spring-framework/blob/master/spring-web/src/main/java/org/springframework/web/util/pattern/PathPatternParser.java

    LORIKEET CHANGES:
    repackaged from org.springframework.web.util.pattern to lorikeet.spring
    replaced org.springframework.web.util.pattern.PatternParseException with lorikeet.spring.PatternParseException
    replaced org.springframework.web.util.pattern.InternalPathPatternParser with lorikeet.spring.InternalPathPatternParser
 */
