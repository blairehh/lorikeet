...
/*
    SOURCE:
    https://github.com/spring-projects/spring-framework/blob/master/spring-web/src/main/java/org/springframework/web/util/pattern/CaptureTheRestPathElement.java
    ...
    replaced org.springframework.http.server.PathContainer.PathSegment with lorikeet.spring.PathContainer.PathSegment
    replaced org.springframework.util.LinkedMultiValueMap with lorikeet.spring.LinkedMultiValueMap
    replaced org.springframework.util.MultiValueMap with lorikeet.spring.util.MultiValueMap
...
import lorikeet.spring.PathContainer.PathSegment;
